...
public class ChatServer {
    //룸 목록
    static Map<Integer, List<ChatThread>> rooms = new HashMap<>();
...
class ChatThread extends Thread {
    ...
    private Map<String, PrintWriter> chatClient;
    ...
    public ChatThread(Socket socket) {
        ...
        try {
            ...
            System.out.println(nickname + " 님의 IP 주소는 " + socket.getLocalAddress().getHostAddress() + "\n");
